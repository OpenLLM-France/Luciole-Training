...
def run_pretraining(xp_name, data_path, output_path):
    recipe = configure_recipe(xp_name, data_path, output_path, nodes=1, gpus_per_node=4)
    ...
    recipe.model.config.ffn_hidden_size = 3584

    recipe.optim.config.lr = 0.0003

    # optimizations:
    # recipe.model.config.bf16 = True
    recipe.model.config.fp8 = True
