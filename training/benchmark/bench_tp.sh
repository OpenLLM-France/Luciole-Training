...
python ../train/slurm_launcher.py --output_dir audran/benchmark --arch llama8b --num_nodes 64 --mode benchmark --tp 2
python ../train/slurm_launcher.py --output_dir audran/benchmark --arch llama8b --num_nodes 64 --mode benchmark --tp 1 --pp 2
