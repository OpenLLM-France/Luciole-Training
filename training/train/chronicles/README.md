...
```bash
cd train/
python slurm_launcher.py --output_path $OpenLLM_OUTPUT/train --mode phase1 --num_nodes 128 --arch llama1b --email ogouvert@linagora.com
```
...
```bash
cd train/
python slurm_launcher.py --output_path $OpenLLM_OUTPUT/train --mode phase2 --num_nodes 128 --arch llama1b --email ogouvert@linagora.com
```
