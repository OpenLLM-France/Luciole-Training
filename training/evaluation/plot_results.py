...
task_group_mapping = {
    "en": [
        ...
        #("lighteval|global_mmlu_cs_eng_cf:high_school_mathematics|0", "acc_norm_pmi"),
        #("lighteval|global_mmlu_cs_eng_cf:high_school_government_and_politics|0","acc_norm_pmi"),
        #("lighteval|global_mmlu_cs_eng_cf:high_school_european_history|0","acc_norm_pmi"),
        #("lighteval|global_mmlu_ca_eng_cf:high_school_mathematics|0", "acc_norm_pmi"),
        #("lighteval|global_mmlu_ca_eng_cf:high_school_government_and_politics|0","acc_norm_pmi"),
        #("lighteval|global_mmlu_ca_eng_cf:high_school_european_history|0","acc_norm_pmi"),
        #("lighteval|global_mmlu_cs_eng_cf:high_school_us_history|0","acc_norm_pmi"),
        #("lighteval|global_mmlu_ca_eng_cf:high_school_us_history|0","acc_norm_pmi"),
    ],
    ...
    "fr":[
        ...
        #("lighteval|global_mmlu_cs_fra_cf:high_school_mathematics|0", "acc_norm_pmi"),
        #("lighteval|global_mmlu_cs_fra_cf:high_school_government_and_politics|0","acc_norm_pmi"),
        #("lighteval|global_mmlu_cs_fra_cf:high_school_european_history|0","acc_norm_pmi"),
        #("lighteval|global_mmlu_ca_fra_cf:high_school_mathematics|0", "acc_norm_pmi"),
        #("lighteval|global_mmlu_ca_fra_cf:high_school_government_and_politics|0","acc_norm_pmi"),
        #("lighteval|global_mmlu_ca_fra_cf:high_school_european_history|0","acc_norm_pmi"),
        #("lighteval|global_mmlu_cs_fra_cf:high_school_us_history|0","acc_norm_pmi"),
        #("lighteval|global_mmlu_ca_fra_cf:high_school_us_history|0","acc_norm_pmi"),
    ],
    "cultural": [
        ("lighteval|global_mmlu_cs_eng_cf:_average|0", "acc_norm"),
        ("lighteval|global_mmlu_ca_eng_cf:_average|0", "acc_norm"),
