...
if __name__ == "__main__":
    ...
    pipeline = [
        JsonlReader(
            ...
            glob_pattern="lf_proverbes_prompts.jsonl",
            text_key="question",
        ),
        ...
        InferenceRunner(
            ...
            checkpoints_local_dir=f"{DATA_PATH}/lf_proverbes/checkpoints",
            output_writer=JsonlWriter(
                f"{DATA_PATH}/lf_proverbes/data",
    ...
    inference_executor = create_executor(
        ...
        local=args.local,
        debug=args.debug,
        logging_dir=f"{DATA_PATH}/lf_proverbes/logs",
