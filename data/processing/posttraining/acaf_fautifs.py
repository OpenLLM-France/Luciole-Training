...
def simple_query_builder(runner, document):
    PROMPT = """Vous êtes membre de l'Académie française, qui clarifie divers abus linguistiques pour le grand public. Pour l'exemple suivant d'« emploi fautif », reformulez le passage donné afin de fournir une explication détaillée.
...
if __name__ == "__main__":
    ...
    pipeline = [
        JsonlReader(
            ...
            glob_pattern="acaf_emploisfautifs_prompts*.jsonl",
            text_key="question",
        ),
        ...
        InferenceRunner(
            ...
            checkpoints_local_dir=f"{DATA_PATH}/acaf_fautifs/checkpoints",
            output_writer=JsonlWriter(
                f"{DATA_PATH}/acaf_fautifs/data",
    ...
    inference_executor = create_executor(
        ...
        local=args.local,
        debug=args.debug,
        logging_dir=f"{DATA_PATH}/acaf_fautifs/logs",
