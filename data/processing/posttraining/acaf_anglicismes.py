...
if __name__ == "__main__":
    ...
    pipeline = [
        JsonlReader(
            ...
            glob_pattern="acaf_anglicismes_prompts*.jsonl",
            text_key="question",
        ),
        ...
        InferenceRunner(
            ...
            checkpoints_local_dir=f"{DATA_PATH}/acaf_anglicismes/checkpoints",
            output_writer=JsonlWriter(
                f"{DATA_PATH}/acaf_anglicismes/data",
    ...
    inference_executor = create_executor(
        ...
        local=args.local,
        debug=args.debug,
        logging_dir=f"{DATA_PATH}/acaf_anglicismes/logs",
        job_name="acaf_anglicismes",
        tasks=1,
        time="02:00:00",
