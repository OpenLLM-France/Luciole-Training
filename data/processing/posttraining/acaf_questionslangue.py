...
def simple_query_builder(runner, document):
    PROMPT = """Vous êtes membre de l'Académie française et un étudiant vous pose une question sur un aspect de la langue. Reformulez le passage ci-dessous pour répondre à l'étudiant de manière aussi détaillée que possible.
...
if __name__ == "__main__":
    ...
    pipeline = [
        ...
        InferenceRunner(
            ...
            checkpoints_local_dir=f"{DATA_PATH}/acaf_questionsdelangue/checkpoints",
            output_writer=JsonlWriter(
                f"{DATA_PATH}/acaf_questionsdelangue/data",
    ...
    inference_executor = create_executor(
        ...
        local=args.local,
        debug=args.debug,
        logging_dir=f"{DATA_PATH}/acaf_questionsdelangue/logs",
        job_name="acaf_questionsdelangue",
        tasks=1,
        time="02:00:00",
