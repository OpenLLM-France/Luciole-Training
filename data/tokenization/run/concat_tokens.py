...
if __name__ == "__main__":
    ...
    parser.add_argument("inputs", type=str, nargs="+", help="Input indexed dataset filenames (with extension .bin or without extension)")
    parser.add_argument("output", type=str, help="Output filenames prefix (with extension .bin or without extension)")
    parser.add_argument(
    ...
    assert all(os.path.exists(input_file + ".bin") for input_file in inputs), "All input .bin files must exist."
    assert all(os.path.exists(input_file + ".idx") for input_file in inputs), "All input .idx files must exist."
